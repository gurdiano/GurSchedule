from view.resources.utility.srcs import BED, BOOK_BIBLE, BOOK, CART, CROSS, DUMBBELL, FOOD_DINNER, SLEEP_MOON, UNTENSILS, WORKOUT
from view.resources.utility.colors import CTHEME_1
