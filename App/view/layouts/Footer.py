...
from App.view.resources.utility.dividers import ROW3, ROW4, COL1, COL4
from App.view.resources.utility.colors import BLACK_0
...
class Footer(ft.Container):
    def __init__(self, father, freetimers=None, sleeptimers=None):
        ...
        self.height = self.father.height * ROW3
        ...
        self.timers = ft.Column(
            width=self.father.width * COL4,
            height=self.father.height * ROW3,
            spacing=0,   
        )
